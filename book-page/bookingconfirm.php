...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for using our System! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                ...
                <h3 style="color: orange;">The driver will contact you and payment will be done via cash on arrival </h3>
                <br>
...
<footer class="site-footer">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h5>© <?php echo date("Y"); ?> Elite-cabs</h5>
            </div>
        </div>
    </div>
</footer>
